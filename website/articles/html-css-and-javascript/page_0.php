<p>Okay, so we got a webserver, now what? You could be a professional and reasonable person and use a website-builder, if your host provides one, or install WordPress or whatever. But I wanted to make things myself, so I got cPanel, a Linux based platform for web hosting. And this is where the fun starts:</p>
...
<?php late_image(get_source("picture_1.webp"),"","width:100%; display: block;"); ?>
...
<p><span class="code" style="color:var(--pico-8-cyan);">&lt;body&gt;</span> contains all visual stuff</p>
<p><span class="code" style="color:var(--pico-8-cyan);">&lt;h1&gt;</span> is a header <span class="code" style="color:var(--pico-8-cyan);">&lt;&#47;h1&gt;</span></p>
<p><span class="code" style="color:var(--pico-8-cyan);">&lt;p&gt;</span> is a paragraph <span class="code" style="color:var(--pico-8-cyan);">&lt;&#47;p&gt;</span></p>
<p><span class="code" style="color:var(--pico-8-cyan);">&lt;a </span><span class="code" style="color:var(--pico-8-red);">href</span><span class="code" style="color:var(--pico-8-black);">=</span><span class="code" style="color:var(--pico-8-purple);">&#34;https://youtu.be/dQw4w9WgXcQ&#34;</span><span class="code" style="color:var(--pico-8-cyan);">&gt;</span> is a hyperlink <span class="code" style="color:var(--pico-8-cyan);">&lt;&#47;a&gt;</span></p>
<p><span class="code" style="color:var(--pico-8-cyan);">&lt;div&gt;</span> is a container, in which you can insert other tags <span class="code" style="color:var(--pico-8-cyan);">&lt;&#47;div&gt;</span></p>
<p><span class="code" style="color:var(--pico-8-cyan);">&lt;ul&gt;</span> is a list, which contains <span class="code" style="color:var(--pico-8-cyan);">&lt;li&gt;</span> individual items <span class="code" style="color:var(--pico-8-cyan);">&lt;&#47;li&gt;</span><span class="code" style="color:var(--pico-8-cyan);">&lt;&#47;ul&gt;</span></p>
<p><span class="code" style="color:var(--pico-8-cyan);">&lt;table&gt;</span> is a table (duh)<br><span class="code" style="color:var(--pico-8-cyan);">&lt;tr&gt;</span> defines a row in a table, and<br><span class="code" style="color:var(--pico-8-cyan);">&lt;td&gt;</span> defines a single cell in a row <span class="code" style="color:var(--pico-8-cyan);">&lt;&#47;td&gt;</span><br><span class="code" style="color:var(--pico-8-cyan);">&lt;&#47;tr&gt;</span><br><span class="code" style="color:var(--pico-8-cyan);">&lt;&#47;table&gt;</span></p>
<p><span class="code" style="color:var(--pico-8-cyan);">&lt;img </span><span class="code" style="color:var(--pico-8-red);">href</span><span class="code" style="color:var(--pico-8-black);">=</span><span class="code" style="color:var(--pico-8-purple);">&#34;this is an image, and&#34;</span><span class="code" style="color:var(--pico-8-cyan);">&gt;</span></p>
<p><span class="code" style="color:var(--pico-8-cyan);">&lt;button&gt;</span> is simply a button <span class="code" style="color:var(--pico-8-cyan);">&lt;&#47;button&gt;</span></p>
