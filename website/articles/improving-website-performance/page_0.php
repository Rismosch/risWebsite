...
<?php late_image(get_source("picture_3.png"),"pixel_image","width:100%; margin:auto; display: block;"); ?>
...
<p class="code code_block">./cwebp.exe "&lt;source file&gt;" -o "&lt;target file&gt;"</p>

<p><span class="code">&lt;source file&gt;</span> is the image that you want to convert, for example a png or jpg. <span class="code">&lt;target file&gt;</span> is the generated WebP file. Make sure that you include the whole file path with the file extensions. Also be careful of your target path, because the program will overwrite whatever target you choose.</p>

<p>An example could look something like this:</p>

<p class="code code_block">./cwebp.exe "C:\Users\Rismosch\Desktop\ugly_mug.jpg" -o "C:\Users\Rismosch\Desktop\ugly_mug.webp"</p>

<p>Press Enter and you should see the following thing:</p>

<?php late_image(get_source("picture_7.webp"),"","max-width:100%; margin:auto; display: block;"); ?>

<p>Here’s the result:</p>

<table>
<tr>
<td><?php late_image(get_source("ugly_mug.jpg"),"","max-width:100%; margin:auto; display: block;"); ?></td>
<td><?php late_image(get_source("ugly_mug.webp"),"","max-width:100%; margin:auto; display: block;"); ?></td>
</tr>
</table>
...
<tr>
<td><?php late_image(get_source("small_image.png"),"pixel_image","width:100%; margin:auto; display: block;"); ?></td>
<td><?php late_image(get_source("small_image.webp"),"pixel_image","width:100%; margin:auto; display: block;"); ?></td>
</tr>
</table>

<?php late_image(get_source("picture_8.webp"),"","max-width:100%; margin:auto; display: block;"); ?>
...
<p>Where I want the image to appear in the HTML, I just call <span class="code">late_image()</span> with the correct source, class and style. It automatically creates this pseudo image tag. It also stores the URL for later. Then finally in my <span class="code">echo_foot()</span> function, I have this piece of code:</p>
...
<p>With using this for every picture, except the banner, all images generated by <span class="code">late_image()</span> will be loaded late, except the banner. In the picture below, you see the network analysis of one of my blogposts. You see after the HTML and a bunch of CSS and JavaScript files are loaded, the 1x1 placeholder gif is the first thing to be "downloaded" and right after my sprite sheet. All other pngs or webps are loaded somewhere after.</p>

<?php late_image(get_source("picture_9.webp"),"","max-width:100%; margin:auto; display: block;"); ?>
