			...
			<?php
				if($dbConn){
					...
					echo "
						<div class=\"dropdown\">
							...
							<div id=\"dropdownList\" class=\"dropdownContent\">
								<a href=\"https://www.rismosch.com/blog?ct=0&ls={$show}&pg=0\" ";
					...
					if($categoriesNumRows > 0)
					{
						...
						{
							echo "
								<a href=\"https://www.rismosch.com/blog?ct={$categoryRow['id']}&ls={$show}&pg=0\" ";
					...
					if($countNumRows > 0)
					{
						...
						if($page > 1 && $page < $pageCount + 1)
						{
							$previousPage = $page - 1;
							echo "
								<a title=\"{$previousPage}\" href=\"https://www.rismosch.com/blog?ct={$category}&ls={$show}&pg={$previousPage}\" class=\"button\">&lt;</a>
							";
						}
						else
						{
						...
						{
							echo "
								<a title=\"{$i}\" href=\"https://www.rismosch.com/blog?ct={$category}&ls={$show}&pg={$i}\" class=\"button\">";
						...
						if($page < $pageCount && $page > 0)
						{
							$nextPage = $page + 1;
							echo "
								<a title=\"{$nextPage}\" href=\"https://www.rismosch.com/blog?ct={$category}&ls={$show}&pg={$nextPage}\" class=\"button\">&gt;</a>
							";
						}
						else
						{
